...
<body style="background-color: azure;">
                ...
                <div class="col py-4">
                    <div class="nv">
                        <h1><a href="navigasi_visitor.php">NAMA APLIKASI</a></h1>
                            <ul>
                                <li><a href="../visitor/dashboard_visitor.php">Dashboard</a></li>
                                <li><a href="../login/login.php">Biota</a></li>
                                <li><a href="../login/login.php">Pakan</a></li>
                                <li><a href="../login/login.php">Keramba</a></li>
                                <li><a href="../login/login.php">Panen</a></li>
                                <li><a href="../login/login.php">Riwayat</a></li>
    ...
    <header>
        <div class="container">
            <div class="row"></div>
        <div class="row">
            <div class="col-xxl-12 py-5" style="background-image: url(../img/karimun.jpg); background-size: cover;" >
                <div class="bg-wlc">
                    <div class="wlc">
    ...
    <main class="container">
        <div class="row">
            ...
            <div class="col-md-8 py-5">
                <h1 class="crop"><a href="../login/login.php">Hasil Monitoring Biomassa Ikan 
        ...
        <div class="row">
            ...
            <div class="col-md-8 py-5">
                <h1 class="fish"><a href="../login/login.php">Jenis ikan yang sedang dibudidayakan
                    pada KJABB</a></h1>
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ad reprehenderit libero unde ullam ducimus sunt, saepe fugit animi accusamus accusantium excepturi corrupti aut tenetur? Cumque quasi ratione ipsam facere quod?</p>
            </div>
        </div>
        <div class="row">
            ...
            <div class="col-md-8 py-5">
                <h1 class="feed"><a href="../login/login.php">Informasi Pakan Pada budidaya 
                    ikan di KJABB</a></h1>
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ad reprehenderit libero unde ullam ducimus sunt, saepe fugit animi accusamus accusantium excepturi corrupti aut tenetur? Cumque quasi ratione ipsam facere quod?</p>
            </div>
        </div>
