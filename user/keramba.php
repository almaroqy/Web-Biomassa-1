...
<body style="background-color: azure;">
    ...
    <header>
        <div class="container">
            <div class="row"></div>
        <div class="row">
            <div class="col-xxl-12 py-5" style="background-image: url(../img/keramba.jpg); background-size: cover;" >
                <div class="bg-wlc">
                    <div class="wlc-ker">
                        <h1>KERAMBA</h1>
                        <p>dasdasoiduasoiduasoidusaoiuoiu</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <main class="container"><br>
        <div class="row">
            <div class="col-md-12 py-5">
                <div class="nav-tb">
                    <ul>
                        <li><a href="../user/tambah_keramba.php">Tambah Data</a></li>
                        <li>I</li>
                        <li><a href="../user/ubah_keramba.php">Ubah Data</a></li>
